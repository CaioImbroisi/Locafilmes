...
<template>
    <div class="text-center bg-red-500 w-4/5 m-auto mt-12 mb-12 shadow-lg">
        <div class="p-10">
            <h1 class="text-2xl">What is Lorem Ipsum?</h1><br />
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
                ...
                PageMaker including versions of Lorem Ipsum.</p><br />
            <h1 class="text-2xl">Where does it come from?</h1>
